...
$$\sum_{k=1}^n f(x_k^*)(x_k-x_{k-1}),\quad x_k^*\in [x_{k-1},x_k],\ \ a=x_0<x_1<\dots < x_n=b$$
\pause
\item weighted integral
$$\sum_{k=1}^n f(x_k^*)(\alpha(x_k)-\alpha(x_{k-1})),\quad x_k^*\in [x_{k-1},x_k],\ \ a=x_0<x_1<\dots < x_n=b$$
\end{itemize}
\end{frame}
