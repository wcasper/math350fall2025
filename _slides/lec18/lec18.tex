...
If $a_n>0$ and $b_n > 0$ and there exists $c>0$ and $N\in\mathbb Z_+$ with $a_n < cb_n$ then
...
$$\liminf a_n = \lim_n \inf\{a_k: 1\leq \leq n\}$$
$$\limsup a_n = \lim_n \sup\{a_k: 1\leq \leq n\}$$
\end{defn}
\begin{thm}
If $a_n$ is bounded above, then $\limsup a_n$ exists and if $a_n$ is bounded below, then $\liminf a_n$ exists.
\end{thm}
If $a_n$ is not bounded above, we write $\liminf a_n = \infty$.
If $a_n$ is not bounded below, we write $\liminf a_n = -\infty$.
\end{frame}
